...
describe('GetDetailThreadUseCase', () => {
  ...
  it('should orchestrating get thread action correctly with comments and replies with 0 likes', async () => {
    // Arrange
    const id = 'thread-123';
  ...
  it('should orchestrating get thread action correctly with comments and replies with more than 0 likes', async () => {
    // Arrange
    const id = 'thread-123';
  ...
  it('should orchestrating get thread action correctly with comments and replies with more than 0 likes and no replies in comment id', async () => {
    // Arrange
    const id = 'thread-123';
  ...
  it('should orchestrating get thread action correctly with comments and replies with 0 likes and no replies in comment id', async () => {
    // Arrange
    const id = 'thread-123';
